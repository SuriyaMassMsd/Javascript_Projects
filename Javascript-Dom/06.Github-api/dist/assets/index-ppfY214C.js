(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))n(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function o(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(e){if(e.ep)return;e.ep=!0;const r=o(e);fetch(e.href,r)}})();const c=document.querySelector("form"),d=["sharif-22","vk2401","riyaz1000","hema-venkat3","yrd369","mushkir","bearcin46","dineshdevelope","mshajid","muthuakalya","vedhatech002","SuriyaMassMsd","danielace1","gayathrihg","kishorekumar-kp","muthukumarimoorthi","swethadsalvatore","jeya-rosini","esakki2104prsnl"];c.addEventListener("submit",function(s){s.preventDefault();const o=new FormData(c).get("username");p(o)});function p(s){fetch(`https://api.github.com/users/${s}`,{method:"GET"}).then(t=>t.json()).then(t=>{s===t.login?fetch(`https://api.github.com/users/${s}`,{method:"GET"}).then(o=>o.json()).then(o=>l(o)):alert("Enter a vaild userName")})}d.map(s=>{fetch(`https://api.github.com/users/${s}`,{method:"GET"}).then(t=>t.json()).then(t=>l(t))});function l({avatar_url:s,name:t,html_url:o,followers:n,following:e,login:r}){const i=document.querySelector("main");let a=document.createElement("section");a.classList="bg-[#06647c] p-5 rounded-lg shadow-md shadow-black",a.innerHTML=`
