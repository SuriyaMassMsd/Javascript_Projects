...
const validateSchema = z.object({
  fullName: z
    .string()
    .regex(/[A-Z,a-z]/g, { message: "name must be a stirng" })
    .min(3)
    .max(10),
  ...
  return (
    <div>
      ...
      <div className="absolute top-0 bg-white max-w-3xl w-full ml-72 mt-20 shadow-2xl  grid grid-cols-2">
        <div className="bg-gradient-to-b from-fuchsia-600 to-blue-700 ">
        ...
        <form className="p-10 space-y-8 " onSubmit={handleSubmit(submitForm)}>
          <SignUp
            label="Name"
            name="fullName"
