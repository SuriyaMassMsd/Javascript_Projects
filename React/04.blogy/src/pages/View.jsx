...
const View = () => {
    ...
    useEffect(() => {
      const blogsPost = async () => {
        ...
        const getPostApi = await fetch( `https://api.slingacademy.com/v1/sample-data/blog-posts/${id}`);
        const response = await getPostApi.json();
        
        setBlogy(response.blog);
      };
  ...
  return (
    ...
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col space-y-4 mt-5 ">
        <div className="flex  flex-col sm:flex-row gap-10 sm:gap-[390px]">
          <div>
            <span className="text-gray-500"> Updated at {updated_at}</span>
          </div>
          <div>
    ...
    <div className="px-16">
      <div className="flex items-center gap-2 my-4 sm:my-2">
        ...
        />
        <span className="text-red-600 font-semibold cursor-pointer hover:text-red-700">
          {category}
        </span>
      </div>

      <h1 className="font-semibold  my-4 text-xl">{title}</h1>
      <h1 className="text-wrap text-gray-700  mt-8 leading-7 tracking-wide font-semibold">
        {content_text}
      </h1>
    </div>
  </div>
